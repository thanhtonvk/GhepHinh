...
public class HuyenActivity extends AppCompatActivity {
    ...
    ActivityHuyenBinding binding;
    DatabaseReference reference;
    FirebaseDatabase database;
    List<Entity> entityList = new ArrayList<>();
    HuyenAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHuyenBinding.inflate(getLayoutInflater());
    ...
    private void onClick() {
        binding.btnGhepHinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                reference.child("Huyen").child(Common.idTinh).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        reference.child("Tinh").child(Common.idKhuVuc).child(Common.idTinh).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    private void init() {
        ...
        adapter = new HuyenAdapter(this, entityList);
